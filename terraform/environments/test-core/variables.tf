...
variable "network_name" {
  description = "libvirt network name for test-core environment."
  type        = string
  default     = "test-core-net"
}

variable "network_domain" {
  description = "DNS domain suffix associated with environment network."
  type        = string
  default     = "test-core.northgate.local"
}

variable "network_cidr" {
  description = "CIDR for the test-core network."
  type        = string
}

variable "network_gateway" {
  description = "Default gateway for test-core VM interfaces."
  type        = string
}
...
variable "network_dns_servers" {
  description = "Deterministic DNS server list used for all test-core VMs."
  type        = list(string)
}
