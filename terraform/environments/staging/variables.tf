...
variable "network_name" {
  description = "libvirt network name for staging environment."
  type        = string
  default     = "staging-net"
}
...
variable "network_domain" {
  ...
  type        = string
  default     = "staging.northgate.local"
}

variable "network_cidr" {
  description = "CIDR for the staging network."
  type        = string
}

variable "network_gateway" {
  description = "Default gateway for staging VM interfaces."
  type        = string
}
...
variable "network_dns_servers" {
  description = "Deterministic DNS server list used for all staging VMs."
  type        = list(string)
}
